...
public class DisksTableModel extends AbstractTableModel {
    ...
    private final String[] COLUMN_NAME = {Messages.get("Home.Evidences.DisksDialog.Name"), Messages.get("Home.Evidences.DisksDialog.Model"), Messages.get("Home.Evidences.DisksDialog.Size"), Messages.get("Home.Evidences.DisksDialog.Serial")};
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        if(disksList == null)
            return "";
        switch (columnIndex){
            case 0: return disksList.get(rowIndex).getName();
            case 1: return disksList.get(rowIndex).getModel();
            case 2: return getDiskSize(disksList.get(rowIndex).getSize());
            case 3: return disksList.get(rowIndex).getSerial();
            default: return "";
        }
    }
