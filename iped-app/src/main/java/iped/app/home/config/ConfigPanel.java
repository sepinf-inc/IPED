...
public class ConfigPanel extends DefaultPanel {
    ...
    /**
     * Default Constructor
     * @param mainFrame - Application MainFrame Reference
     */
    ...
    private void createFormComponentInstances(){
        ...
        //A variable to check if the app is runnong on Windows. You can use to test the Linux behavior
        ...
        //Create a TextField to show the IndexTemp Path, a JButton to select a new IndexPath location and a JButton to set the Default indexPath Value
        ...
        //Create a TextField to show the HashDBFile Path, a JButton to select a new HashDBFile location and a CheckBox to enable or disable this option
        ...
        //Attention -- This TextField can be showed or hide based on operational system in use. This behavior is controlled by createFormPanel() method
        ...
        //Create a TextField to show the Option Plugin Path and a Button to select a new one
        //Attention -- When user select a new path, we save the relative path and not the absolute path
     ...
     * @param iconResourceString - Icon resource reference
     ...
     * @param baseDirectory - The base Path to be showed
    ...
    /**
     * @param title - File Chooser Title
     * @param fileFilterName - Name of the filter
     * @param filters - The filters values
     * @param buttonName - Select file button name
     ...
     * @param components - List of components to be added on JPanel
