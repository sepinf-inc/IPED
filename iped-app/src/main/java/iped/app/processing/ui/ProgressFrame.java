...
public class ProgressFrame extends JFrame implements PropertyChangeListener, ActionListener {
    ...
    private static class RestrictedSizeLabel extends JLabel {
        ...
        static {
            ...
            try {
                ...
                Map<Key, Object> desktopHints = (Map<Key, Object>) Toolkit.getDefaultToolkit().getDesktopProperty("awt.font.desktophints");
    ...
    private void updateTaskBar() {
        if (Taskbar.isTaskbarSupported()) {
            ...
            taskbar.setWindowProgressState(this, paused ? State.PAUSED : taskSize == 0 ? State.INDETERMINATE : State.NORMAL);
            if (taskSize != 0) {
