...
public final class SwingUtils {
     ...
     * component hierarchy and return nested components that are instances of class
     ...
     * component hierarchy and returns the first found component that is an instance
     * of class <code>clazz</code> having the bound property value. Returns
     ...
     * Convenience method that searches below <code>container</code> in the
     * component hierarchy and returns the first found component that is an instance
     * of class <code>clazz</code> and has the bound property value. Returns
     * {@code null} if such component cannot be found.
     * 
     * @param clazz
    ...
    /**
     * Convenience method for searching below <code>container</code> in the
     * component hierarchy and return nested components of class <code>clazz</code>
     * it finds. Returns an empty list if no such components exist in the container.
     * <P>
    ...
    public static <T extends JComponent> List<T> getDescendantsOfClass(Class<T> clazz, Container container,
        ...
        for (Component component : container.getComponents()) {
            ...
            if (nested || !clazz.equals(component.getClass())) {
                tList.addAll(SwingUtils.<T>getDescendantsOfClass(clazz, (Container) component, nested));
            }
        }
        return tList;
    }
     ...
     * @param value
     *            the value of the bound property
     * @return the component, or null if no such component exists in the container's
     *         hierarchy.
     * @throws java.lang.IllegalArgumentException
     *             if the bound property does not exist for the class or cannot be
     *             accessed
    ...
    private static <T extends JComponent> T getComponentFromList(Class<T> clazz, List<T> list, String property,
        ...
        try {
            ...
            throw new IllegalArgumentException(
                    "Property " + property + " cannot be accessed in class " + clazz.getName());
    ...
    /**
     * Convenience method for mapping a container in the hierarchy to its contained
     * components. The keys are the containers, and the values are lists of
     * contained components.
     * <P>
     * Implementation note: The returned value is a HashMap and the values are of
     * type ArrayList. This is subject to change, so callers should code against the
     * interfaces Map and List.
     * 
     * @param container
    ...
    /**
     * Convenience method for retrieving a subset of the UIDefaults pertaining to a
     * particular class.
     * 
     * @param clazz
    ...
    /**
     * Convenience method for obtaining most non-null human readable properties of a
     * JComponent. Array properties are not included.
     * <P>
