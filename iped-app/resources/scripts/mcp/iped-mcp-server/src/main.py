...
def register_tools():
    ...
    mcp.tool(name="read_batch", description="Read both the metadata and text content of multiple documents/messages in a single batch call.")(documents.read_batch)
