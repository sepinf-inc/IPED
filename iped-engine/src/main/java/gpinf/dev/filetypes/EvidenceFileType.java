 ...
 */
public abstract class EvidenceFileType implements IEvidenceFileType {
     ...
     */
    public abstract void processFiles(File baseDir, List<iped3.IItem> items);
    ...
    /**
     * Retorna o tipo de visulização que deve ser utilizado pelo visualizador para
     * este tipo de arquivo.
     *
     * @return Tipo de visualização.
     *
     *         public ViewType getViewType() { //Implementação padrão retorna "sem
     *         visualização" return ViewType.NONE; }
     *
     ...
     * @return Novo nome do arquivo, trocando o diretório inicial para VIEW_DIR e
     *         substituindo a extensão original pela especificada.
     */
