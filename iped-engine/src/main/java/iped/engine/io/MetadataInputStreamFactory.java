...
public class MetadataInputStreamFactory extends SeekableInputStreamFactory {
    ...
    private boolean includeMeta(String meta) {
        if (fromMetadataPreview) {
            ...
            return meta.startsWith(ExtraProperties.UFED_META_PREFIX) || meta.startsWith(ExtraProperties.MESSAGE_PREFIX) || meta.startsWith(ExtraProperties.COMMON_META_PREFIX);
        }
