...
public class BitcoinAddressValidatorService extends BasicAbstractRegexValidatorService {
    ...
    public List<String> getRegexNames() {
        return Arrays.asList("CRYPTOCOIN_BITCOIN_ADDRESS", "CRYPTOCOIN_BITCOIN_BIP38_ENC_PRIV_K",
                "CRYPTOCOIN_BITCOIN_WIF_PRIV_K_UNC_PUB_K", "CRYPTOCOIN_BITCOIN_WIF_PRIV_K_COMP_PUB_K",
                "CRYPTOCOIN_BITCOIN_BIP32_HD_XPRV_KEY", "CRYPTOCOIN_BITCOIN_BIP32_HD_XPUB_KEY");
    }
