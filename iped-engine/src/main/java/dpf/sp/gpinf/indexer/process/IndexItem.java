...
public class IndexItem extends BasicProps {
    ...
    public static Document Document(IItem evidence, Reader reader, File output) {
        ...
        List<byte[]> similarityFeaturesList = (List<byte[]>) evidence.getExtraAttribute(ImageSimilarityTask.SIMILARITY_FEATURES);
        ...
        if (similarityFeaturesList != null) {
            for(byte[] similarityFeatures: similarityFeaturesList) {
