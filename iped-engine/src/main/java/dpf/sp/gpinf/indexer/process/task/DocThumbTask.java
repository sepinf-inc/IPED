...
public class DocThumbTask extends ThumbTask {
    ...
    public void init(Properties confParams, File confDir) throws Exception {
        ...
        if (loEnabled) {
            ...
            String[] cmd = { loPath + "/program/soffice.bin", "--headless", "--quickstart", "--norestore",
                    "--nolockcheck", "-env:UserInstallation=file://" + loOutPath };
        ...
        synchronized (finished) {
            if (!finished.get()) {
                ...
                if (taskEnabled) {
                    ...
                    if (totalLO != 0) {
                        logger.info("Average LibreOffice processing time (ms/item): "
                                + (totalLoTime.longValue() / totalLO));
                    }
    ...
    protected void process(IItem item) throws Exception {
        if (!taskEnabled || !item.isToAddToCase()
                || ((!pdfEnabled
                        || !isPdfType(item.getMediaType()) && (!loEnabled || !isLibreOfficeType(item.getMediaType())))
                        || item.getHashValue() == null || item.getThumb() != null
    ...
    private boolean isLibreOfficeType(MediaType mediaType) {
        ...
        return m.startsWith("application/msword") || m.equals("application/rtf")
                || m.startsWith("application/vnd.ms-word")
                || m.startsWith("application/vnd.openxmlformats-officedocument")
                || m.startsWith("application/vnd.oasis.opendocument") || m.startsWith("application/vnd.sun.xml")
                || m.startsWith("application/vnd.stardivision") || m.equals("application/vnd.visio")
                || m.equals("application/x-mspublisher") || m.equals("application/postscript") || m.equals("image/wmf")
                || m.equals("image/x-portable-bitmap") || m.equals("image/svg+xml") || m.equals("image/x-pcx")
                || m.equals("image/vnd.dxf") || m.equals("image/cdr") || m.equals("application/coreldraw")
                ...
                || m.startsWith("application/vnd.ms-excel") || m.startsWith("application/x-tika-msworks-spreadsheet")
    ...
    private void createPDFThumb(IItem item, File thumbFile) {
        ...
        try {
            if (externalPdfConversion) {
                ...
                String[] cmd = { "java", "-cp", classpath, "-Xmx" + maxPdfExternalMemory + "M",
                        PDFToThumb.class.getCanonicalName(), file.getAbsolutePath(), String.valueOf(thumbSize) };
                ...
                try (BufferedReader in = new BufferedReader(new FileReader(cfgIn));
                    ...
                    while ((line = in.readLine()) != null) {
                        ...
                        if (++cnt == 2) {
                            ...
                            out.newLine();
                            out.write(
                                    "<item oor:path=\"/org.openoffice.Office.Impress/Filter/Import/VBA\"><prop oor:name=\"Load\" oor:op=\"fuse\"><value>false</value></prop></item>");
                            out.newLine();
                            out.write(
                                    "<item oor:path=\"/org.openoffice.Office.Writer/Filter/Import/VBA\"><prop oor:name=\"Load\" oor:op=\"fuse\"><value>false</value></prop></item>");
                            out.newLine();
                            out.write(
                                    "<item oor:path=\"/org.openoffice.Office.Calc/Filter/Import/VBA\"><prop oor:name=\"Load\" oor:op=\"fuse\"><value>false</value></prop></item>");
                            out.newLine();
                            out.write(
                                    "<item oor:path=\"/org.openoffice.Office.Common/Path/Current\"><prop oor:name=\"Temp\" oor:op=\"fuse\"><value xsi:nil=\"true\"/></prop></item>");
                            out.newLine();
                            out.write(
                                    "<item oor:path=\"/org.openoffice.Office.Common/Path/Info\"><prop oor:name=\"WorkPathChanged\" oor:op=\"fuse\"><value>false</value></prop></item>");
                            out.newLine();
                            out.write(
                                    "<item oor:path=\"/org.openoffice.Office.Paths/Paths/org.openoffice.Office.Paths:NamedPath['Temp']\"><prop oor:name=\"WritePath\" oor:op=\"fuse\"><value>file://"
