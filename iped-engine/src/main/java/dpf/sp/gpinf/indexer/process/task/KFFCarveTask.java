...
public class KFFCarveTask extends BaseCarveTask {
  ...
  private static boolean isAcceptedType(MediaType mediaType) {
    return mediaType.getBaseType().equals(UNALLOCATED_MIMETYPE) || mediaType.getBaseType().equals(mtPageFile) || mediaType.getBaseType().equals(mtDiskImage) || mediaType.getBaseType().equals(mtUnknown)
