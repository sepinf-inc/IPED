 ...
 * esteja em disco SSD e a imagem esteja compactada (e01), pode aumentar consideravelmente a
 * performance pois os itens deixam de ser descompactados múltiplas vezes pela libewf, a qual não é
 * thread safe e sincroniza descompactações concorrentes, subaproveitando máquinas multiprocessadas.
 *
 * @author Nassif
 *
 */
