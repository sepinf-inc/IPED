          ...
          do {
            ...
            if (term != null) {
              ...
              if (totalHits == 1) {
                ...
                webEngine.executeScript("document.getElementById(\"indexerHit-" + ++currentHit + "\").scrollIntoView(false);"); //$NON-NLS-1$ //$NON-NLS-2$
              }
        ...
        if (forward) {
          ...
          if (doc != null) {
            ...
            while (currTerm > -1) {
              ...
              if ((Boolean) webEngine.executeScript("window.find(\"" + queryTerms[currTerm] + "\", false, true)")) { //$NON-NLS-1$ //$NON-NLS-2$
                break;
              } else {
                currTerm--;
                if (currTerm != -1) {
