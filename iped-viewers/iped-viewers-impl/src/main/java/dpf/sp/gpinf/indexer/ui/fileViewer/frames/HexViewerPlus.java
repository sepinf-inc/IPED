...
public class HexViewerPlus extends Viewer implements KeyListener, MouseListener {
    ...
    public HexViewerPlus() {
        ...
        charsetComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ISO-8859-1","UTF-8", "UTF-16", "UTF-16BE", "US-ASCII", "IBM852" }));
    ...
    static class searchKPMWorker extends iped3.desktop.CancelableWorker<String, Integer>{
        ...
        protected String doInBackground() throws Exception {            
                    ...
                    while (posicao < dataSize - bufferLength){
                        ...
                        if (this.interromper){
                            progressBarSearch.setString((int)(((double)posicao/(double)dataSize)*100) + "% - Interrompido");                            
                            break;
                        }
