...
public class HexViewerPlus extends Viewer implements KeyListener, MouseListener {
	...
	public interface HexSearcher{
		...
		abstract void doSearch(CodeArea codeArea, HighlightCodeAreaPainter painter, Hits hits,SeekableInputStream data,  Charset charset, Set<String> highlightTerms, long offset  ,boolean searchString, boolean ignoreCaseSearch, JLabel resultSearch,int max_hits) throws Exception;
	}	
	...
	public boolean verificarSalvarArquivo(String arquivo){
		...
		if(fileName!=null && fileName.exists()){					
			fileName = null;
			int n = JOptionPane.showOptionDialog(dialogOpcoes,"'"+arquivo+"' "+Messages.getString("HexViewerPlus.overWriteFile"),appName,
			...
			public void actionPerformed(ActionEvent e) {	
				...
				if(contentAux!=null){
					try {
						...
						dialogPesquisar.setVisible(false);	
						hexSearcher.doSearch(codeArea, painter, hits,contentAux.getStream(),charsetParam,palavras, off,jrbTexto.isSelected(), !jcbCase.isSelected(), resultSearch, max_hits);	
		...
		textfield.addKeyListener(new KeyAdapter() {
			...
			public void keyTyped (KeyEvent ev) {
				...
				if (textAllowed){
					...
					if (isDigitBase(c) || k == KeyEvent.VK_BACK_SPACE || k == KeyEvent.VK_DELETE || k == KeyEvent.VK_RIGHT || k == KeyEvent.VK_LEFT || k == KeyEvent.VK_ENTER
						|| k == KeyEvent.VK_KP_LEFT || k == KeyEvent.VK_KP_RIGHT || k == KeyEvent.VK_END || k == KeyEvent.VK_ESCAPE || k == KeyEvent.VK_HOME || paste || copy) {
						return;
					}else{
						ev.consume();
					}
...
class ImageFileView extends FileView {
	...
	static byte [] imageArray = {
		(byte)0x89 ,(byte)0x50 ,(byte)0x4E ,(byte)0x47 ,(byte)0x0D ,(byte)0x0A ,(byte)0x1A ,(byte)0x0A ,(byte)0x00 ,(byte)0x00 ,(byte)0x00 ,(byte)0x0D ,(byte)0x49 ,(byte)0x48 ,(byte)0x44 ,(byte)0x52 ,(byte)0x00 ,(byte)0x00 ,(byte)0x00 ,(byte)0x10 ,(byte)0x00 ,(byte)0x00 ,(byte)0x00 ,(byte)0x10 ,(byte)0x08 ,(byte)0x02 ,(byte)0x00 ,(byte)0x00 ,(byte)0x00 ,(byte)0x90 ,(byte)0x91 ,(byte)0x68 ,(byte)0x36 ,(byte)0x00 ,(byte)0x00 ,(byte)0x00 ,(byte)0x09 ,(byte)0x70 ,(byte)0x48 ,(byte)0x59 ,(byte)0x73 ,(byte)0x00 ,(byte)0x00 ,(byte)0x0E ,(byte)0xC4 ,(byte)0x00 ,(byte)0x00 ,(byte)0x0E ,(byte)0xC4 ,(byte)0x01 ,(byte)0x95 ,(byte)0x2B ,(byte)0x0E ,(byte)0x1B ,(byte)0x00 ,(byte)0x00 ,(byte)0x00 ,(byte)0xE0 ,(byte)0x49 ,(byte)0x44 ,(byte)0x41 ,(byte)0x54 ,(byte)0x78 ,(byte)0xDA ,(byte)0x75 ,(byte)0x92 ,(byte)0xBD ,(byte)0x11 ,(byte)0x83 ,(byte)0x30 ,(byte)0x0C ,(byte)0x85 ,(byte)0xDF ,(byte)0x71 ,(byte)0x19 ,(byte)0x05 ,(byte)0x28 ,(byte)0x72 ,(byte)0x4C ,(byte)0xA0 ,(byte)0x0D ,(byte)0xB8 ,(byte)0xF4 ,(byte)0xB4 ,(byte)0xE9 ,(byte)0x9C ,(byte)0x96 ,(byte)0x01 ,(byte)0x52 ,(byte)0x66 ,(byte)0x00 ,(byte)0x53 ,(byte)0x86 ,(byte)0x29 ,(byte)0x52 ,(byte)0x99 ,(byte)0x0D ,(byte)0x3C ,(byte)0x41 ,(byte)0x8E ,(byte)0x02 ,(byte)0xB1 ,(byte)0x8B ,(byte)0x52 ,(byte)0x04 ,(byte)0xFC ,(byte)0x87 ,(byte)0xF9 ,(byte)0x2A ,(byte)0x23 ,(byte)0x78 ,(byte)0xB2 ,(byte)0x9E ,(byte)0x1E ,
,(byte)0x00 ,(byte)0x00 ,(byte)0x00 ,(byte)0x00 ,(byte)0x49 ,(byte)0x45 ,(byte)0x4E ,(byte)0x44 ,(byte)0xAE ,(byte)0x42 ,(byte)0x60 ,(byte)0x82
	};
...
class Messages {
	...
	static {
		...
		map.put( "HexViewerPlus.TabName", "Hex" );
		map.put( "HexViewerPlus.appName", "Hex Viewer Plus" );
		map.put( "HexViewerPlus.HvpFileSettings", "Arquivo de Configuração do Hex Viewer Plus" );		
		map.put( "HexViewerPlus.position", "Posição" );
		map.put( "HexViewerPlus.relative", "Relativo" );
		map.put( "HexViewerPlus.charset", "Charset" );
		map.put( "HexViewerPlus.selection", "Seleção" );
		map.put( "HexViewerPlus.to", "a" );
		map.put( "HexViewerPlus.settings", "Configurações" );
		map.put( "HexViewerPlus.hit", "Ocorrência" );
		map.put( "HexViewerPlus.hits", "Ocorrências" );
		map.put( "HexViewerPlus.of", "de" );		
		map.put( "HexViewerPlus.search", "Pesquisar" );
		map.put( "HexViewerPlus.nextHit", "Próxima ocorrência" );
		map.put( "HexViewerPlus.preHit", "Ocorrência anterior" );
		map.put( "HexViewerPlus.goToHit", "Ir para ocorrência" );
		map.put( "HexViewerPlus.goToPosition", "Ir para Posição" );
		map.put( "HexViewerPlus.selectBlock", "Selecionar Bloco" );
		map.put( "HexViewerPlus.selectAll", "Selecionar Tudo" );
		map.put( "HexViewerPlus.copyHex", "Copiar Hexadecimal" );
		map.put( "HexViewerPlus.copyText", "Copiar Texto" );
		map.put( "HexViewerPlus.options", "Opções" );
		map.put( "HexViewerPlus.selectColor", "Selecione uma cor" );
		map.put( "HexViewerPlus.codeArea", "Conteúdo" );
		map.put( "HexViewerPlus.header", "Cabeçalho" );
		map.put( "HexViewerPlus.layout", "Layout" );
		map.put( "HexViewerPlus.cursor", "Cursor" );
		map.put( "HexViewerPlus.mode", "Modo" );
		map.put( "HexViewerPlus.font", "Fonte" );
		map.put( "HexViewerPlus.size", "Tamanho" );
		map.put( "HexViewerPlus.blink", "Taxa" );
		map.put( "HexViewerPlus.bytesPerLine", "Bytes por linha" );
		map.put( "HexViewerPlus.cursorColor", "Cor do Cursor" );
		map.put( "HexViewerPlus.fontColor", "Cor da Fonte" );
		map.put( "HexViewerPlus.backGroundColor", "Cor do Fundo" );
		map.put( "HexViewerPlus.selectionCharactersMirror", "Seleção de Caracteres - Espelho" );
		map.put( "HexViewerPlus.selectionCharactersMain", "Seleção de Caracteres - Principal" );		
		map.put( "HexViewerPlus.searchHitsFoundMatch", "Ocorrência ao Pesquisar - Encontrado" );
		map.put( "HexViewerPlus.searchHitsCurrentMatch", "Ocorrência ao Pesquisar - Selecionado" );
		map.put( "HexViewerPlus.loadDefault", "Carregar Padrão" );
		map.put( "HexViewerPlus.saveDefault", "Salvar Padrão" );
		map.put( "HexViewerPlus.loadFile", "Carregar Arquivo" );
		map.put( "HexViewerPlus.saveFile", "Salvar Arquivo" );
		map.put( "HexViewerPlus.close", "Fechar" );
		map.put( "HexViewerPlus.ok", "OK" );
		map.put( "HexViewerPlus.cancel", "Cancel" );
		map.put( "HexViewerPlus.hexLowerCase", "Hexadecimal minúsculo" );
		map.put( "HexViewerPlus.showHeader", "Mostrar cabecalho" );
		map.put( "HexViewerPlus.showLines", "Mostrar linhas" );
		map.put( "HexViewerPlus.lineBreak", "Quebra de linha" );
		map.put( "HexViewerPlus.showAllCharacters", "Exibir todos os caracteres" );
		map.put( "HexViewerPlus.failOpenFile", "Erro ao abrir arquivo!" );
		map.put( "HexViewerPlus.failSaveFile", "Erro ao salvar arquivo!" );
		map.put( "HexViewerPlus.yes", "Sim" );
		map.put( "HexViewerPlus.no", "Não" );
		map.put( "HexViewerPlus.overWriteFile", "já existe.\nDeseja substituí-lo?" );
		map.put( "HexViewerPlus.select", "Seleção" );
		map.put( "HexViewerPlus.type", "Tipo" );
		map.put( "HexViewerPlus.interval", "Intervalo" );
		map.put( "HexViewerPlus.startPosition", "Posição Inicial" );
		map.put( "HexViewerPlus.endPosition", "Posição Final" );
		map.put( "HexViewerPlus.format", "Formato" );
		map.put( "HexViewerPlus.hexadecimal", "Hexadecimal" );
		map.put( "HexViewerPlus.decimal", "Decimal" );
		map.put( "HexViewerPlus.octal", "Octal" );
		map.put( "HexViewerPlus.invalidStartPosition", "Posição Inicial inválida!" );
		map.put( "HexViewerPlus.invalidSize", "Tamanho inválido!" );
		map.put( "HexViewerPlus.invalidEndPosition", "Posição final inválida!" );
		map.put( "HexViewerPlus.start", "Início" );
		map.put( "HexViewerPlus.cursor", "Cursor" );
		map.put( "HexViewerPlus.invalidHit", "Ocorrência inválida!" );
		map.put( "HexViewerPlus.text", "Texto" );
		map.put( "HexViewerPlus.all", "Todas" );
		map.put( "HexViewerPlus.max", "Máximo" );
		map.put( "HexViewerPlus.caseSensitive", "Diferenciar MAIÚSCULAS / minúsculas" );
		map.put( "HexViewerPlus.invalidSearchText", "Texto para pesquisa inválido!" );
		map.put( "HexViewerPlus.invalidHexadecimalText", "Hexadecimal para pesquisa inválido!" );
		map.put( "HexViewerPlus.invalidMax", "Máximo inválido!" );
		...
		map.put( "HexSearcherImpl.of", "de" );
		map.put( "HexSearcherImpl.timeLeft", "Tempo Restante" );		
		map.put( "HexSearcherImpl.noHits", "Nenhum resultado encontrado" );
		...
		map.put( "HexViewerPlus.TabName", "Hex" );
		map.put( "HexViewerPlus.appName", "Hex Viewer Plus" );
		map.put( "HexViewerPlus.HvpFileSettings", "Hex Viewer Plus File Settings" );		
		map.put( "HexViewerPlus.position", "Position" );
		map.put( "HexViewerPlus.relative", "Relative" );
		map.put( "HexViewerPlus.charset", "Charset" );
		map.put( "HexViewerPlus.selection", "Selection" );
		map.put( "HexViewerPlus.to", "to" );
		map.put( "HexViewerPlus.settings", "Settings" );
		map.put( "HexViewerPlus.hit", "Hit" );
		map.put( "HexViewerPlus.hits", "Hits" );
		map.put( "HexViewerPlus.of", "of" );		
		map.put( "HexViewerPlus.search", "Search" );
		map.put( "HexViewerPlus.nextHit", "Next Hit" );
		map.put( "HexViewerPlus.preHit", "Previous Hit" );
		map.put( "HexViewerPlus.goToHit", "Go to Hit" );
		map.put( "HexViewerPlus.goToPosition", "Go to Position" );
		map.put( "HexViewerPlus.selectBlock", "Select Block" );
		map.put( "HexViewerPlus.selectAll", "Select All" );
		map.put( "HexViewerPlus.copyHex", "Copy Hexadecimal" );
		map.put( "HexViewerPlus.copyText", "Copy Text" );
		map.put( "HexViewerPlus.options", "Options" );
		map.put( "HexViewerPlus.selectColor", "Pick a Color" );
		map.put( "HexViewerPlus.codeArea", "Code Area" );
		map.put( "HexViewerPlus.header", "Header" );
		map.put( "HexViewerPlus.layout", "Layout" );
		map.put( "HexViewerPlus.cursor", "Cursor" );
		map.put( "HexViewerPlus.mode", "Mode" );
		map.put( "HexViewerPlus.font", "Font" );
		map.put( "HexViewerPlus.size", "Size" );
		map.put( "HexViewerPlus.blink", "Blink" );
		map.put( "HexViewerPlus.bytesPerLine", "Bytes per line" );
		map.put( "HexViewerPlus.cursorColor", "Cursor Color" );
		map.put( "HexViewerPlus.fontColor", "Font Color" );
		map.put( "HexViewerPlus.backGroundColor", "Background Color" );
		map.put( "HexViewerPlus.selectionCharactersMirror", "Select Characters - Mirror" );
		...
		map.put( "HexViewerPlus.searchHitsCurrentMatch", "Search Hits - Current Match" );
		map.put( "HexViewerPlus.loadDefault", "Load Default" );
		map.put( "HexViewerPlus.saveDefault", "Save Default" );
		map.put( "HexViewerPlus.close", "Close" );
		map.put( "HexViewerPlus.ok", "OK" );
		map.put( "HexViewerPlus.cancel", "Cancel" );
		map.put( "HexViewerPlus.hexLowerCase", "Hexadecimal lowercase" );
		map.put( "HexViewerPlus.showHeader", "Show Header" );
		map.put( "HexViewerPlus.showLines", "Show Lines" );
		map.put( "HexViewerPlus.lineBreak", "Line Break" );
		map.put( "HexViewerPlus.showAllCharacters", "Show All Characters" );
		map.put( "HexViewerPlus.loadFile", "Load File" );
		map.put( "HexViewerPlus.saveFile", "Save File" );
		map.put( "HexViewerPlus.failOpenFile", "Failed to Open File!" );
		map.put( "HexViewerPlus.failSaveFile", "Failed to Save File!" );
		map.put( "HexViewerPlus.yes", "Yes" );
		map.put( "HexViewerPlus.no", "No" );
		map.put( "HexViewerPlus.overWriteFile", "already exists. Overwrite?" );
		map.put( "HexViewerPlus.select", "Selection" );
		map.put( "HexViewerPlus.type", "Type" );
		map.put( "HexViewerPlus.interval", "Interval" );
		map.put( "HexViewerPlus.startPosition", "Start Position" );
		map.put( "HexViewerPlus.endPosition", "End Position" );
		map.put( "HexViewerPlus.format", "Format" );
		map.put( "HexViewerPlus.hexadecimal", "Hexadecimal" );
		map.put( "HexViewerPlus.decimal", "Decimal" );
		map.put( "HexViewerPlus.octal", "Octal" );
		map.put( "HexViewerPlus.invalidStartPosition", "Invalid Start Position!" );
		map.put( "HexViewerPlus.invalidSize", "Invalid Size!" );
		map.put( "HexViewerPlus.invalidEndPosition", "Invalid End Position!" );
		map.put( "HexViewerPlus.start", "Start" );
		map.put( "HexViewerPlus.cursor", "Cursor" );
		map.put( "HexViewerPlus.invalidHit", "Invalid Hit!" );
		map.put( "HexViewerPlus.text", "Text" );
		map.put( "HexViewerPlus.all", "All" );
		map.put( "HexViewerPlus.max", "Max" );
		map.put( "HexViewerPlus.caseSensitive", "Case Sensitive" );
		map.put( "HexViewerPlus.invalidSearchText", "Invalid Serach Text!" );
		map.put( "HexViewerPlus.invalidHexadecimalText", "Invalid Hexadecimal Search!" );
		map.put( "HexViewerPlus.invalidMax", "Invalid Max" );
		map.put( "HexViewerPlus.invalidMaxLessThen", "Invalid Max. Less than or equal to " );
		...
		map.put( "HexSearcherImpl.of", "of" );
		map.put( "HexSearcherImpl.timeLeft", "Time Left" );		
		map.put( "HexSearcherImpl.noHits", "No results found" );
