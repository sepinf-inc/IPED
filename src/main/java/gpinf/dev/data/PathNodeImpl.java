 ...
 * em uma mesma pasta, economizando espaço de armazenamento. Além disso esta estrutura permite uma
 * navegação biderecional (pai para filhos) das pastas.
 *
...
/**
  ...
  /**
   * Descendentes do nó atual. É utilizado um mapa que associa nome dos nós filhos com os próprios
   * nós filhos para permitir a obtenção dos mesmos a partir do nome.
   */
  ...
  /**
   * Construtor privado para nós "não-raiz". Utilizado pelo método de adição de novos nós a um nó.
   *
   ...
   *
   * @param path Caminho completo do novo nó (xxx\yyy\zzz).
...
*/  }
  ...
  /**
   * Retorna o caminho completo corresponte ao nó atual, percorrendo a árvore na order inversa.
   *
...
*/  }
   ...
   *
   * @param node nó ancestral
   * @return <code>true</code> se este nó estiver abaixo no mesmo ramo da árvore de hierarquia de
   * nós, senão <code>false</code>.
   */
  ...
  /**
   * Compara um nó com outro, utilizando ordenação por nome dentro de uma mesma pasta.
   *
   * @param pn outro nó a ser comparado
   * @return negativo se este nó for menor que o outro, 0 se for igual e positivo se for maior.
   */
  @Override
  ...
  /**
   * Constrói o array de filhos, a partir do mapa de filhos. Chama recursivamente a atualização para
   * os filhos.
   */
