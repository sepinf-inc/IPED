...
/**
 * Implementação da classe utilizada para arquivos não suportados (desconhecidos).
 *
...
public class GenericFileType extends EvidenceFileTypeImpl {
  ...
  /**
   * Ícone associado ao tipo. * private static final Icon icon = IconUtil.createIcon("ft-unknown");
   *
   ...
   *
   * @param descr Descrição a ser utilizada pélo método de obtenção da descrição.
   */
  ...
  /**
   * Retorna o ícone correspondente ao tipo de arquivo. * public Icon getIcon() { return icon; }
   */
}
