...
public class ParseUtil {
	...
	/**
	 * Interpreta uma String contendo um número utilizando pontos como separador
	 * de milhar. Apenas elimina os pontos, ou seja, se houver outros caracteres
	 * não numéricos uma exceção será disparada.
	 * 
	 * @param strNumber
