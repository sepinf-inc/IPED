...
public class ParseUtil {
   ...
   *
   * @param strDateTime String com data e hora
   * @return Date correspondente.
   * @throws DateFormatException Data inválida.
   */
  ...
  /**
   * Interpreta uma String contendo um número utilizando pontos como separador de milhar. Apenas
   * elimina os pontos, ou seja, se houver outros caracteres não numéricos uma exceção será
   * disparada.
   *
   * @param strNumber String com o número, por exemplo "1.234.567".
   * @return número correspondente.
   * @throws NumberFormatException Número inválido.
   */
