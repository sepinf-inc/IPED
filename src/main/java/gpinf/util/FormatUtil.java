...
public class FormatUtil {
   ...
   *
   * @param date Objeto da class Date a ser formatado.
   * @return String com a data formatada. No caso da data ser nula ou inválida retorna uma String
   * vazia.
   */
   ...
   * @return String com o número formatado. No caso do número ser nulo retorna uma String vazia.
   */
