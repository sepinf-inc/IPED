...
/**
 * Painel especializado em exibi��o de uma imagem. J� inclui rolagem e zoom da
 * imagem.
 * 
...
public class ImageViewPanel extends JPanel {
	...
	/**
	 * Painel para exibi��o da imagem (inserido dentro do componente de
	 * rolagem).
	 */
	...
	public ImageViewPanel() {
		...
		imgPanel = new JPanel() {
			 ...
			 * 
			 * @param g
			 *            contexto gr�fico a ser utilizado
			 */
			@Override
	 ...
	 * 
	 * @param imageFile
	 *            Arquivo de imagem a ser exibido. Valor nulo � aceito,
	 *            indicando que nenhum arquivo deve ser exibido, ou seja, um
	 *            painel vazio deve ser apresentado.
	 ...
	 * 
	 * @param img
	 *            Imagem a ser exibida. Valor nulo � aceito, indicando que
	 ...
	 * 
	 * @param factor
	 *            Fator multiplicador de amplia��o (se maior que 1) ou redu��o
	 *            (se menor que 1) a ser aplicado.
	 * @param reference
	 *            Ponto de refer�ncia que deve permanecer o mais pr�ximo
	 *            poss�vel da localiza��o que se encontrava antes da aplica��o
	 *            do zoom. Se for <code>null</code> considera o centro da �rea
	 *            vis�vel como ponto de refer�ncia.
	 */
