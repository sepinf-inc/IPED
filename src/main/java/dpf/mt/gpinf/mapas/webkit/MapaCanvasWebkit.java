...
public class MapaCanvasWebkit extends AbstractMapaCanvas {
	...
	public void setKML(String kml) {
		  try {
			  ...
			  String b64_selecionado = "data:image/png;base64," + Base64.getEncoder().encodeToString(IOUtils.toByteArray(getClass().getResourceAsStream("marcador_selecionado.png"))); //$NON-NLS-1$ //$NON-NLS-2$
			  String b64_selecionado_m = "data:image/png;base64," + Base64.getEncoder().encodeToString(IOUtils.toByteArray(getClass().getResourceAsStream("marcador_selecionado_m.png"))); //$NON-NLS-1$ //$NON-NLS-2$
			  String b64_normal = "data:image/png;base64," + Base64.getEncoder().encodeToString(IOUtils.toByteArray(getClass().getResourceAsStream("marcador_normal.png"))); //$NON-NLS-1$ //$NON-NLS-2$
			  String b64_marcado = "data:image/png;base64," + Base64.getEncoder().encodeToString(IOUtils.toByteArray(getClass().getResourceAsStream("marcador_marcado.png"))); //$NON-NLS-1$ //$NON-NLS-2$
