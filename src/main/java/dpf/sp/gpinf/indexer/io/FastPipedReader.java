...
public class FastPipedReader extends Reader {
	 ...
	 * character of data will be stored when received from the connected piped
	 * writer. <code>in&lt;0</code> implies the buffer is empty,
	 ...
	 * buffer. Data written to <code>src</code> will then be available as input
	 * from this stream.
	 * 
	 * @param src
	 *            the stream to connect to.
	 ...
	 * <p>
	 * If <code>src</code> is an unconnected piped writer and <code>snk</code>
	...
	/**
	 * Receives data into an array of characters. This method will block until
	...
	/**
	 * Reads the next character of data from this piped stream. If no character
	...
	/**
	 * Reads up to <code>len</code> characters of data from this piped stream
	 * into an array of characters. Less than <code>len</code> characters will
	 * be read if the end of the data stream is reached or if <code>len</code>
	 * exceeds the pipe's buffer size. This method blocks until at least one
	...
	/**
	 * Closes this piped stream and releases any system resources associated
	 * with the stream.
	 * 
	 * @exception IOException
	 *                if an I/O error occurs.
