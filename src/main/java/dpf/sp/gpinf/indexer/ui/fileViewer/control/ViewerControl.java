...
public interface ViewerControl {
     ...
     * antigo 'addViewers da classe CompositeViewerHelper'
    ...
    /**
     * Reinicializa a biblioteca LibreOffice. 
     * Método recomendado de ser utilizado após uma atualização de layout
     */
