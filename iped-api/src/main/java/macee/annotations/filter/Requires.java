...
/**
 * Specifies the item types that are accepted by the method, after both filter (category and status)
 * are applied.
 * 
 * COMENTÁRIO (Werneck): anotação que reune as demais. Talvez seja mais elegante fazer as anotações separadas.
 *
 * @author WERNECK
 */
