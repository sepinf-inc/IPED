 ...
 * 
 * No lugar (ou além) do EventBus, poderia utilizar também um Flow (Java 9) para
 * que os objetos subscrevam vários fluxos de eventos.
 * https://docs.oracle.com/javase/9/docs/api/java/util/concurrent/Flow.html
 *
 * @param <M>
 *            the type of modules used in the application.
