...
/**
 * This interface is used to indicate an extensible object. Extension providers
 * can registered and retrieved.
 *
...
public interface Extensible {
     ...
     *            the extension type.
     * @param extensionType
     *            the class representing the extension type.
     * @param descriptor
     ...
     *
     * @param extension
     *            the extension to be called.
     * @throws Exception
     *             if an exception occurs while running the extension method.
     */
