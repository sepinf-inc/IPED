...
/**
 * This interface is used to indicate a configurable object that holds configuration for both the
 * application and the user.
 * 
 * COMENTÁRIO (Werneck): era usado em App só pra separar a configuração global da configuração
 * de usuário. Não define carregamento ou salvamento de configurações. Poderia ser usado nos
 * módulos, sendo AppConfig uma configuração global do aplicative e UserConfig, uma configuração
 * própria do módulo.
 * 
 * TO DO: mudar nomes dos métodos para atender o comentário acima.
 *
 * @param <AppConfig>  the type used for the application configuration
 * @param <UserConfig> the type used for the user configuration
