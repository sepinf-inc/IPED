...
/**
 * Defines a basic component interface that can be loaded by a {@link Module}.
 * It uses the same event bus from the parent module.
 *
 * @param <T>
 *            the type of module associated with this component.
...
public interface Component<T extends Module> extends Lifecycle {
     ...
     *
     * @param module
     *            the module to be associated with this component.
     */
