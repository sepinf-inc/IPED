...
/**
 * Defines a platform (the place where the app is running). The platform must
 * have an unique ID in the environment.
 *
...
public interface Platform extends ObjectRef {
    ...
    /**
     * Information about the underlying platform resources such as memory, number of
     * cores, network interfaces and storage.
     *
