 ...
 * @author WERNECK
 */
public interface IPathNode extends Comparable<IPathNode>, Serializable {
     ...
     */
    IPathNode addNewPath(String path);
     ...
     */
    int getIndexOfChild(IPathNode child);
     ...
     */
    boolean isDescendantOf(IPathNode node);
