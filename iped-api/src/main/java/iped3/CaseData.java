 ...
 */
public interface CaseData extends Serializable {
   ...
   */
  void addBookmark(FileGroup bookmark);
  ...
  void addItemToQueue(Item item, int queuePriority) throws InterruptedException;
   ...
   */
  void addTimeGroup(FileGroup timeGroup);
   ...
   */
  LinkedBlockingDeque<Item> getItemQueue();
