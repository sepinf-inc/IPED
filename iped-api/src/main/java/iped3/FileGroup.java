 ...
 * agrupamento dos arquivos de evidência do caso.
 *
 * @author Wladimir Leite (GPINF/SP)
 */
public interface FileGroup extends Serializable {
   ...
   *
   * @return o nome do arquivo que lista os arquivos pertencentes a este agrupamento
   */
  String getFileName();
