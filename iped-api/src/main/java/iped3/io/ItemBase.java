...
public interface ItemBase extends StreamSource {
	  /**
	   *
	   * @return o id do item
	   */
    ...
    */
	...
	/**
	 * @return the local File referenced by this Item, null if it does not exist (eg item into a DD image).
	 * 
	 * @see iped3.io.StreamSource#getFile()
	 */
	public File getFile();
