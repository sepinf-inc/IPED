...
public class TimeConverter {
    /**
     * Converts a 64-bit NTFS time value (number of 100-nanosecond intervals since
     * January 1, 1601 UTC) to a Java time value (number of milliseconds since
     * January 1, 1970 UTC.)
     * 
     * @param filetime
     *            the FILETIME value.
    ...
    /**
     * Converts a 64-bit NTFS time value (number of 100-nanosecond intervals since
     * January 1, 1601 UTC) to a Java {@link Date}.
     * 
     * @param filetime
     *            the FILETIME value.
