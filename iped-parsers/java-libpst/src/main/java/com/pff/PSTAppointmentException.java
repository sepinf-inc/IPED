...
public class PSTAppointmentException {
    ...
    PSTAppointmentException(byte[] recurrencePattern, int offset, int writerVersion2, PSTAppointment appt) {
        ...
        if ((OverrideFlags & ARO_SUBJECT) != 0) {
            ...
            // offset, offset+2);
            offset += 2;
            short SubjectLength2 = (short) PSTObject.convertLittleEndianBytesToLong(recurrencePattern, offset,
                    offset + 2);
            offset += 2;
        ...
        if ((OverrideFlags & ARO_LOCATION) != 0) {
            ...
            // offset, offset+2);
            offset += 2;
            short LocationLength2 = (short) PSTObject.convertLittleEndianBytesToLong(recurrencePattern, offset,
                    offset + 2);
            offset += 2;
    ...
    void ExtendedException(byte[] recurrencePattern, int offset) {
        ...
        if (writerVersion2 >= 0x00003009) {
            int ChangeHighlightSize = (int) PSTObject.convertLittleEndianBytesToLong(recurrencePattern, offset,
                    offset + 4);
            offset += 4;
            ChangeHighlightValue = (int) PSTObject.convertLittleEndianBytesToLong(recurrencePattern, offset,
                    offset + 4);
        ...
        if ((OverrideFlags & ARO_SUBJECT) != 0) {
            WideCharSubjectLength = (short) PSTObject.convertLittleEndianBytesToLong(recurrencePattern, offset,
                    offset + 2);
            offset += 2;
        ...
        if ((OverrideFlags & ARO_LOCATION) != 0) {
            WideCharLocationLength = (short) PSTObject.convertLittleEndianBytesToLong(recurrencePattern, offset,
                    offset + 2);
            offset += 2;
