...
public class TelegramParserTest extends AbstractPkgTest {
    ...
    private void parseTelegramDB(String file) throws IOException, SAXException, TikaException {
    ...
    public void testTelegramParser() throws IOException, SAXException, TikaException {
        parseTelegramDB("test-files/test_telegramCache4.db");
    ...
    @Test
    public void testTelegramParserEmptyDB() throws IOException, SAXException, TikaException {
        parseTelegramDB("test-files/test_telegramEmptyCache4.db");
        assertEquals(0, telegramtracker.title.size());
    }

    @Test
    public void testTelegramParserNoUsersTable() throws IOException, SAXException, TikaException {
        parseTelegramDB("test-files/test_telegramCache4NoUsers.db");
        assertEquals(0, telegramtracker.username.size());
        assertEquals(3, telegramtracker.messagebody.size());
        assertEquals(3, telegramtracker.messagedate.size());
    }

    @Test
    public void testTelegramParserNoChannelUsersTable() throws IOException, SAXException, TikaException {
        parseTelegramDB("test-files/test_telegramCache4NoChannelUsers.db");
        assertEquals(2, telegramtracker.username.size());
        assertEquals(1, telegramtracker.messagebody.size());
        assertTrue(telegramtracker.title.contains("Telegram_Group_mixirica e noronhe-se"));
    }
