...
import iped.parsers.browsers.SafariPlistParser;
...
public class SafariPlistParserTest extends AbstractPkgTest {
    ...
    public void testSafariPlistParserHistory() throws IOException, SAXException, TikaException {
        ...
        parser.setExtractEntries(true);
        try (InputStream stream = getStream("test-files/test_history.plist")) {
            ...
            assertEquals("CNN International - Breaking News, US News, World News and Video",
                    safaritrackerhst.historytitle.get(2));
    ...
    public void testSafariPlistParserBookmarks() throws IOException, SAXException, TikaException {
        ...
        try (InputStream stream = getStream("test-files/test_bookmarks.plist")) {
            ...
            assertEquals("http://www.microsoft.com/isapi/redir.dll?prd=ie&ar=windowsmedia",
                    safaritrackerbkm.bookmarkurl.get(28));
    ...
    public void testSafariPlistParserDownloads() throws IOException, SAXException, TikaException {
        ...
        try (InputStream stream = getStream("test-files/test_downloads.plist")) {
            ...
            assertEquals(
                    "https://dl.google.com/tag/s/appguid%3D%7B8A69D345-D564-463C-AFF1-A69D9E530F96%7D%26iid%3D%7B11C004F6-5199-AABB-BDF6-596927E6C22A%7D%26lang%3Dpt-BR%26browser%3D0%26usagestats%3D0%26appname%3DGoogle%2520Chrome%26needsadmin%3Dprefers%26ap%3Dstable-arch_x86%26installdataindex%3Ddefaultbrowser/update2/installers/win_xp/ChromeSetup.exe",
                    safaritrackerdwl.downloadurl.get(0));
            assertEquals(
                    "https://get.geo.opera.com/pub/opera-winxpvista/36.0.2130.80/win/Opera_winxpvista_36.0.2130.80_Setup.exe",
                    safaritrackerdwl.downloadurl.get(1));
            assertEquals(
            ...
            assertEquals("C:\\Documents and Settings\\guileb\\Meus documentos\\Opera_winxpvista_36.0.2130.80_Setup.exe",
                    safaritrackerdwl.downloadlocalpath.get(1));
            assertEquals("C:\\Documents and Settings\\guileb\\Meus documentos\\Firefox Setup 52.9.0esr.exe",
                    safaritrackerdwl.downloadlocalpath.get(2));
