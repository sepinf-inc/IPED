...
public class EdgeWebCacheParserTest extends AbstractPkgTest {
    ...
    // "C:\\Users\\guilh\\Downloads\\libpff-main\\libesedb-main\\vs2019\\Release\\Win32\\";
    // //$NON-NLS-1$
    ...
    public void testEdgeBookmarkParser() throws IOException, SAXException, TikaException {
        ...
        metadata.add(Metadata.CONTENT_TYPE, MediaType.application("x-edge-web-cache").toString());
