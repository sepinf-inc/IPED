...
public class RARParserTest  extends AbstractPkgTest {
    ...
    public void testSevenZipRAR4Embedded() throws Exception {
        ...
        assertEquals("2411fabd", tracker.itensmd5.get(14));
        ...
        assertEquals("14dd8ace", tracker.itensmd5.get(15));
        ...
        assertEquals("9ac0054b", tracker.itensmd5.get(17));
        ...
        assertEquals("4c1a44e1", tracker.itensmd5.get(18));
