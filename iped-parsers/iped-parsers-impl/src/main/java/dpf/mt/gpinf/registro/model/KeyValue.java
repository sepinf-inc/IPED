        ...
        if (dataLength < 0) {// when most significant bit is set to 1 the data is less than 4 bytes in length
            ...
            if (cell.getCellContent() instanceof DataCell) {
                ...
                if (cell.getCellContent() instanceof BigData) {
                    ...
                    buffer = bd.getData();
                    // System.out.println("Erro: apontando para celula que nao contem
                    // dados:"+cell.getCellContent().getClass().toString());
                }
            }
        ...
        switch (type) {
            ...
            case REG_NONE:
                ...
                if (buffer != null) {
                    result = "";
                    try {
                        // verifica se o tamanho dos dados são de 16 bytes indicando que pode ser do
                        // tipo data
                        if (buffer.length == 16) {
