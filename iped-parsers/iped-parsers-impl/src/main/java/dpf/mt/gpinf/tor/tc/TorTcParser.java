...
/*
 * Parses TC BUILT and EXTENDED Circuit Status Changes responses  
 * fragments on pagefile.sys that are carved by TOR_CIRCUIT_STATUS carver.
 * (Section 4.1.1 of https://torproject.gitlab.io/torspec/control-spec.html#circuit-status-changed) 
 */
