...
public class SkypeMessage {
	...
	public static final short SE_MSG_NAO_ENVIADA = 1; // representa uma mensagem digitada e com o botão enviar pressionado mas não enviada de fato ainda por qualquer motivo. 
	...
	public boolean isEnviada() {
		return (SendingStatus!=SE_MSG_NAO_ENVIADA)
				&&(SendingStatus!=3);
	}
