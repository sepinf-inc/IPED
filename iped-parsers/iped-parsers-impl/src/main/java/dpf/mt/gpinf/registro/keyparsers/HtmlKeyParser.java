...
public class HtmlKeyParser implements RegistryKeyParser {
	...
	private byte[] generateKeyNodeHtml(KeyNode kn, String keyPath) throws UnsupportedEncodingException, NoSuchMethodException, ScriptException {
	...
	public static String getDatatypeString(int type) {
		switch (type) {
		case KeyValue.REG_NONE: return "REG_NONE";
		case KeyValue.REG_SZ: return "REG_SZ";
		case KeyValue.REG_EXPAND_SZ : return "REG_EXPAND_SZ";
		case KeyValue.REG_BINARY : return  "REG_BINARY";
		case KeyValue.REG_DWORD : return "REG_DWORD";
		case KeyValue.REG_DWORD_BIGENDIAN : return "REG_DWORD_BIGENDIAN";
		case KeyValue.REG_LINK : return "REG_LINK";
		case KeyValue.REG_MULTI_SZ : return "REG_MULTI_SZ";
		case KeyValue.REG_RESOURCE_LIST : return "REG_RESOURCE_LIST";
		case KeyValue.REG_FULL_RESOURCE_DESCRIPTOR : return "REG_FULL_RESOURCE_DESCRIPTOR";
		case KeyValue.REG_RESOURCE_REQUIREMENTS_LIST : return "REG_RESOURCE_REQUIREMENTS_LIST";
		case KeyValue.REG_QWORD : return "REG_QWORD";
		default:
	...
	public void startDocument(PrintWriter out){
        ...
        out.println("<style>"+
                ...
                + ".rb { background-color:#E7E7E7; vertical-align: middle; } "
