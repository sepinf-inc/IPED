...
public class SevenZipParser extends AbstractParser{
	...
	public void parse(InputStream stream, ContentHandler handler, Metadata metadata, ParseContext context) throws IOException, SAXException, TikaException {
		...
		final EmbeddedDocumentExtractor extractor = context.get(EmbeddedDocumentExtractor.class, new ParsingEmbeddedDocumentExtractor(context));
	...
	public class MyExtractCallback implements IArchiveExtractCallback {
        ...
        public MyExtractCallback(ISimpleInArchive simpleInArchive, ParseContext context, ContentHandler handler, EmbeddedDocumentExtractor extractor, TemporaryResources tmp) {
