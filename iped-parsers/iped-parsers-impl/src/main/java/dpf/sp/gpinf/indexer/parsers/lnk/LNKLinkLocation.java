...
public class LNKLinkLocation {
	...
	public String getDriveTypeStr() {
		switch (driveType) {
			case 1: return "DRIVE_NO_ROOT_DIR"; //$NON-NLS-1$
			case 2: return "DRIVE_REMOVABLE"; //$NON-NLS-1$
			case 3: return "DRIVE_FIXED"; //$NON-NLS-1$
			case 4: return "DRIVE_REMOTE"; //$NON-NLS-1$
			case 5: return "DRIVE_CDROM"; //$NON-NLS-1$
			case 6: return "DRIVE_RAMDISK"; //$NON-NLS-1$
			default: return "DRIVE_UNKNOWN"; //$NON-NLS-1$
		}
	}
}
