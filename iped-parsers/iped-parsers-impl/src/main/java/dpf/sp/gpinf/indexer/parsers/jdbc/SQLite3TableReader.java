...
class SQLite3TableReader extends JDBCTableReader {
     ...
     */
    @Override
    protected TikaInputStream getInputStreamFromBlob(ResultSet resultSet, int columnIndex, Blob blob, Metadata m) throws SQLException {
    ...
    @Override
    protected void handleInteger(ResultSetMetaData rsmd, ResultSet rs, int col,
