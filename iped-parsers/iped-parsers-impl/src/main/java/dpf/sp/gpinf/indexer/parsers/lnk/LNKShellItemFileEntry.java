...
public class LNKShellItemFileEntry {
	...
	public String getExtensionsSig() {
		if (extensionSigs == null) return null;
	...
	public String getLocalizedNames() {
		if (localizedNames == null) return null;
	...
	public static String toDateStrFromFAT(DateFormat df, long ft) { 
       ...
       */
		...
		if (day < 0 || day > 31 || month < 0 || month > 11) return LNKShortcut.DATA_NAO_SETADA;
		...
		if (hours > 23 || minutes > 59 || seconds > 59) return LNKShortcut.DATA_NAO_SETADA;
