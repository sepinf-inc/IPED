...
/**
 * <p>
 * This class calls #toString() on the ContentHandler, inserts it into the
 * Metadata object and serializes the Metadata object.
 * </p>
 * Ideally, this would serialize the ContentHandler and the Metadata object as
 * separate objects, but we can't guarantee that the ContentHandler is
 * Serializable (e.g. the StringWriter in the WriteOutContentHandler).
 */
