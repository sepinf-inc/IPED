...
public class Message implements Comparable<Message> {
    ...
    public boolean isSystemMessage() {
        switch (messageType) {
            ...
            case EPHEMERAL_SAVE:
            case EPHEMERAL_SETTINGS_NOT_APPLIED:
