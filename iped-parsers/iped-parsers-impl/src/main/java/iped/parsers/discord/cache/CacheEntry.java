...
public class CacheEntry {
	...
	public String getRequestURL() {
		try {
			...
			if (longKey == null) {
				...
				if (longKeyAddress > 0) {
					longKey = new String(longKeyAddressCacheAddress.getInputStream(dataFiles, externalFiles, null)
	...
	public String toString() {
		return "CacheEntry [hash=" + hash + ", nextEntry=" + nextEntry + ", rankingsNode=" + rankingsNode
				...
				+ longKeyAddress + ", dataStreamSize=" + Arrays.toString(dataStreamSize)
				+ ", dataStreamAdresses[ResponseInfo]=" + dataStreamAdresses[0].toString()
				+ ", dataStreamAdresses[ResponseRawDataStream]=" + dataStreamAdresses[1].toString() + ", flags=" + flags
				+ ", paddings=" + Arrays.toString(paddings) + ", selfHash=" + selfHash + ", requestURL="
				+ getRequestURL() + "]";
	}
}
